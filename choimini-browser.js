...
(function () {
  ...
  var PROMPT_KO_BASE = [
    ...
    "3. 액션: navigate(url) new_tab(url) list_tabs current_tab snapshot read_text click(ref) type(ref,text) select(ref,value) check(ref,checked) submit(ref) scroll(dy) wait(ms)",
